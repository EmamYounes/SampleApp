...
data class WeatherResponseByDays(

    @field:SerializedName("current")
    val current: CurrentByDays? = null,

    @field:SerializedName("location")
    val location: LocationByDays? = null,

    @field:SerializedName("forecast")
    val forecast: Forecast? = null
)

data class LocationByDays(
...
data class HourItem(
    ...
    val condition: ConditionByDays? = null,
